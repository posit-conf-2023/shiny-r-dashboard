...
<https://github.com/posit-conf-2023/https://github.com/posit-conf-2023/shiny-r-dashboard>

<br/>

<https://rstd.io/start-shiny> - FIXME
:::
...
::: {style="text-align: center;"}
<https://bit.ly/conf2023_shiny_dashboard>
:::
...
![](images/cloud_assignment.png){fig-align="center" width="60%"} FIXME
...
Copy the code from the previous slide (or open `exercises/ex01.R`) and try running it in your console.
